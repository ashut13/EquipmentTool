                            ...
                            <div class="card-header" style="background-color: #074e70fa;">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td align="right">
                                            <div>
                                                <input type="button" value="Daten Exportieren" style="cursor: pointer;" ng-click="Export()" />
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <div class="card-body">
                                <div id="div_id" class="zui-wrapper">
                                    <div class="zui-scroller" style="min-width: 1279.2px; width: {{screen_width}}">
                                        <table role="table" id="tbl_class" style="background-color: #fff; width: 300%; max-width: 300%" class="table-bordered">
                                            <thead role="rowgroup" style="background-color: #e7e8ed; border: 1px solid #e7e8ed; height: 40px">
                                                <tr role="row">
                                                    <th role="columnheader" style="width: 1%; text-align: center; vertical-align: middle;">S.No</th>
                                                    <th role="columnheader" style="width: 3%; text-align: center; vertical-align: middle;">Architektur</th>
                                                    <th role="columnheader" style="width: 3%; text-align: center; vertical-align: middle;">Derivat</th>
                                                    <th role="columnheader" style="width: 3%; text-align: center; vertical-align: middle;">Planergruppe</th>
                                                    <th role="columnheader" style="width: 3%; text-align: center; vertical-align: middle;">Erfassungsdatum</th>
                                                    <th role="columnheader" style="width: 3%; text-align: center; vertical-align: middle;">Kostenart</th>
                                                    <th role="columnheader" style="width: 3%; text-align: center; vertical-align: middle;">Thema</th>
                                                    <th role="columnheader" style="width: 4%; text-align: center; vertical-align: middle;">Position</th>
                                                    <th role="columnheader" style="width: 3%; text-align: center; vertical-align: middle;">Stuckpreis</th>
                                                    <th role="columnheader" style="width: 4%; text-align: center; vertical-align: middle;">Anzahl</th>
                                                    <th role="columnheader" style="width: 4%; text-align: center; vertical-align: middle;">Summe</th>
                                                    <th role="columnheader" style="width: 4%; text-align: center; vertical-align: middle;">Halle</th>
                                                    <th role="columnheader" style="width: 4%; text-align: center; vertical-align: middle;">Kontrollsumme</th>
                                                    <th role="columnheader" style="width: 3%; text-align: center; vertical-align: middle;">Chance</th>
                                                    <th role="columnheader" style="width: 3%; text-align: center; vertical-align: middle;">Risiko</th>
                                                    <th role="columnheader" style="width: 4%; text-align: center; vertical-align: middle;">Umrechnung</th>
                                                    <th role="columnheader" style="width: 5%; text-align: center; vertical-align: middle;">PM Auftragsnummer</th>
                                                    <th role="columnheader" style="width: 5%; text-align: center; vertical-align: middle;">PM Bezeichnung</th>
                                                    <th role="columnheader" style="width: 5%; text-align: center; vertical-align: middle;">PM Betrag</th>
                                                    <th role="columnheader" style="width: 5%; text-align: center; vertical-align: middle;">PM Erfassungsdatum</th>
                                                    <th role="columnheader" style="width: 5%; text-align: center; vertical-align: middle;">PSP Element</th>
                                                    <th role="columnheader" style="width: 5%; text-align: center; vertical-align: middle;">Bemerkungen</th>
                                                    <th role="columnheader" style="width: 4%; text-align: center; vertical-align: middle;">Beschlussstand</th>
                                                    <th role="columnheader" style="width: 4%; text-align: center; vertical-align: middle;">UmsetzendesGewerk</th>
                                                    <th role="columnheader" style="width: 4%; text-align: center; vertical-align: middle;">Eingefügt von</th>
                                                    <th role="columnheader" style="width: 4%; text-align: center; vertical-align: middle;">Eingefügtes Datum</th>
                                            ...
                                            <tbody role="rowgroup" dir-paginate="t in PositionData|filter:search|itemsPerPage:8">
                                                ...
                                                <tr role="row" id="tr_{{t.DataId}}" ng-if="t.IsActive==2" style="background-color:#074e70fa;color:#fff;display:none;">
                                                    <td role="cell" class="css_td" style="text-align: center; vertical-align: middle;">{{PositionData.indexOf(t) + 1}}</td>
                                                    <td role="cell" class="css_td" style="text-align: center; vertical-align: middle;">{{t.ArchitekturName}}</td>
                                                    <td role="cell" class="css_td" style="text-align: center; vertical-align: middle;">{{t.DerivatName}}</td>
                                                    <td role="cell" class="css_td" style="text-align: center; vertical-align: middle;">{{t.PlanergruppeName}}</td>
