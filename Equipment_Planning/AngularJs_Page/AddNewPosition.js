    ...
    $scope.fn_Save_Data = function () {
        ...
        var httpreq = {
            ...
            data: {
                ...
                HalleId: $("#ddl_Halle").val(), Kontrollsumme: $("#txt_Kontrollsumme").val(), Chance: $("#txt_Chance").val(), Risiko: $("#txt_Risiko").val(), UmrechnungId: $("#ddl_Umrechnung").val(),
                /*PM_Auftragsnummer: $("#txt_PM_Auftragsnummer").val(), PM_Bezeichnung: $("#txt_PM_Bezeichnung").val(), PM_Betrag: $("#txt_PM_Betrag").val(), PM_Erfassungsdatum: $("#txt_PM_Erfassungsdatum").val(), PSP_Element: $("#txt_PSP_Element").val(),*/
